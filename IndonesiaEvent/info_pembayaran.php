<div> 
	<form class="form-horizontal">
		<table class="table table-bordered table-striped">
			...
			<h3>
				<center>
					Info Pembayaran Indonesia Events
				</center>
			</h3>
			<br>
			<h5>
				Setelah melakukan booking tiket online, langkah selanjutnya adalah melakukan transfer sesuai dengan total harga yang tertera pada saat memesan ke salah satu dari nomer rekening yang ada dibawah ini. Jika sudah melakukan transfer, silahkan konfirmasi pembayaran tersebut melalui email konfirmasi@indonesiaevent.com
			</h5>
			<br>
			<thead>
				<tr>
